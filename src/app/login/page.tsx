  ...
  return (
    <main className="flex flex-1 flex-col bg-moonlight/40">
      ...
      <div className="relative mt-8 h-[260px] w-full overflow-hidden sm:h-[320px] lg:h-[380px]">
        <Image
          src="/images/about/jewellery-2.jpg"
          alt=""
          fill
          sizes="100vw"
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center px-6 text-center">
          <p className="eyebrow text-[11px] text-ivory/70">Welcome back</p>
          <h1 className="mt-3 font-serif text-4xl text-ivory sm:text-5xl">Sign In</h1>
